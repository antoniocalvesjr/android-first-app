...
//        setShareIntent(currentViewPagerItem);
    ...
    private final PagerAdapter mPagerAdapter = new PagerAdapter() {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (mInflater == null) {
                mInflater = LayoutInflater.from(com.example.android.actionbarcompat.shareactionprovider.MainActivity2.this);
            }
    ...
    private void setShareIntent(int position) {
        ...
        if (mShareActionProvider != null) {
            ...
            Intent shareIntent = item.getShareIntent(com.example.android.actionbarcompat.shareactionprovider.MainActivity2.this);
